...
| **学生** | 浏览课题、在线选题、**上传/提交各阶段文档**（开题/中期/初稿/终稿）、查看评语与成绩、自助注册 |

> 文档提交同时支持**本地上传**（PDF/Word/PPT/压缩包，最大50MB）和**外部链接**两种方式。
...
| 8 | `submission` | 阶段文档 | FK→selection，支持多版本(version)，CHECK(stage/status)，file_path 存储本地路径(`/files/...`)或外部链接 |
